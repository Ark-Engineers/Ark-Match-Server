...
public class SpineAssetService {
    ...
    private AssetItem toItem(SpineAssetDO d) {
        return new AssetItem(
                ...
                d.getRaceCount() == null ? 0 : d.getRaceCount(),
                d.getFirstPlaceCount() == null ? 0 : d.getFirstPlaceCount(),
                d.getSecondPlaceCount() == null ? 0 : d.getSecondPlaceCount(),
                d.getThirdPlaceCount() == null ? 0 : d.getThirdPlaceCount(),
                d.getUnplacedCount() == null ? 0 : d.getUnplacedCount(),
